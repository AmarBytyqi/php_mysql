...
<head>
    ...
    <title>Cardano - Cryptocurrency Info</title>
...
<div class="container mt-5">
    <div class="card">
        <div class="card-header">
            <img src="<?php echo $data[0]['image']; ?>" class="crypto-logo" alt="Cardano Logo">
    ...
    <div class="chart-container">
        <canvas id="chart-cardano"></canvas>
    </div>
</div>
...
<script>
    ...
    const ctx = document.getElementById('chart-cardano').getContext('2d');
