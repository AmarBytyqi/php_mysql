...
function fetchHistoricalData($cryptoId) {
    $apiUrl = "https://api.coingecko.com/api/v3/coins/{$cryptoId}/market_chart?vs_currency=usd&days=30";
...
<head>
    ...
    <title>Chainlink - Cryptocurrency Info</title>
...
<div class="container mt-5">
    <div class="card">
        <div class="card-header">
            <img src="<?php echo $data[0]['image']; ?>" class="crypto-logo" alt="Chainlink Logo">
    ...
    <div class="chart-container">
        <canvas id="chart-chainlink"></canvas>
    </div>
</div>
...
<script>
    ...
    const ctx = document.getElementById('chart-chainlink').getContext('2d');
    const chart = new Chart(ctx, {
        type: 'line',
        data: {
            labels: labels,
            datasets: [{
                label: 'Chainlink Price (USD)',
                data: prices,
