...
<head>
    ...
    <title>Dogecoin - Cryptocurrency Info</title>
...
<div class="container mt-5">
    <div class="card">
        <div class="card-header">
            <img src="<?php echo $data[0]['image']; ?>" class="crypto-logo" alt="Dogecoin Logo">
    ...
    <div class="chart-container">
        <canvas id="chart-dogecoin"></canvas>
    </div>
</div>
...
<script>
    ...
    const ctx = document.getElementById('chart-dogecoin').getContext('2d');
