...
<head>
    ...
    <title>Ethereum - Cryptocurrency Info</title>
...
<div class="container mt-5">
    <div class="card">
        <div class="card-header">
            <img src="<?php echo $data[0]['image']; ?>" class="crypto-logo" alt="Ethereum Logo">
    ...
    <div class="chart-container">
        <canvas id="chart-ethereum"></canvas>
    </div>
</div>
...
<script>
    ...
    const ctx = document.getElementById('chart-ethereum').getContext('2d');
