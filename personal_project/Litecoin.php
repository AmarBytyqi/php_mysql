...
<head>
    ...
    <title>Litecoin - Cryptocurrency Info</title>
...
<div class="container mt-5">
    <div class="card">
        <div class="card-header">
            <img src="<?php echo $data[0]['image']; ?>" class="crypto-logo" alt="Litecoin Logo">
    ...
    <div class="chart-container">
        <canvas id="chart-litecoin"></canvas>
    </div>
</div>
...
<script>
    ...
    const ctx = document.getElementById('chart-litecoin').getContext('2d');
