...
<head>
    ...
    <title>Polkadot - Cryptocurrency Info</title>
...
<div class="container mt-5">
    <div class="card">
        <div class="card-header">
            <img src="<?php echo $data[0]['image']; ?>" class="crypto-logo" alt="Polkadot Logo">
    ...
    <div class="chart-container">
        <canvas id="chart-polkadot"></canvas>
    </div>
</div>
...
<script>
    ...
    const ctx = document.getElementById('chart-polkadot').getContext('2d');
