...
<head>
    ...
    <title>Ripple - Cryptocurrency Info</title>
...
<div class="container mt-5">
    <div class="card">
        <div class="card-header">
            <img src="<?php echo $data[0]['image']; ?>" class="crypto-logo" alt="Ripple Logo">
...
<script>
    ...
    const ctx = document.getElementById('chart-ripple').getContext('2d');
