...
<head>
    ...
    <title>Solana - Cryptocurrency Info</title>
...
<div class="container mt-5">
    <div class="card">
        <div class="card-header">
            <img src="<?php echo $data[0]['image']; ?>" class="crypto-logo" alt="Solana Logo">
...
<script>
    ...
    const ctx = document.getElementById('chart-solana').getContext('2d');
